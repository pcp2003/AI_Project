...
//    }
    ...
    public int nextMove(double[] currentState) {
        ...
        System.out.println(" RIGHT -->" + fowardState[0]);
        System.out.println(" LEFT -->" + fowardState[1]);
    ...
    public int compareTo(NeuronalNetwork other) {
        return (int) (new BreakoutBoard(this, false, 1).getFitness() - new BreakoutBoard(other, false, 1).getFitness());
    }
}
